           ...
           steps{
                script {
                    ...
                    withSonarQubeEnv('SonarQube') {
                      sh 'mvn sonar:sonar -Dsonar.projectKey=Ms-Maven -Dsonar.host.url=http://172.18.0.3:9000 -Dsonar.login=f02ea950a916c2196fb81575fbf270b425148f15 -Dsonar.dependencyCheck.jsonReportPath=target/dependency-check-report.json -Dsonar.dependencyCheck.xmlReportPath=target/dependency-check-report.xml -Dsonar.dependencyCheck.htmlReportPath=target/dependency-check-report.html'
